...
[[removed_project_exec]]
==== Removed deprecated `Project#exec`, `Project#javaexec` and their script counterparts

Some helper methods to run external processes were <<#deprecated_project_exec, deprecated in Gradle 8.11>> and are removed in Gradle 9.0:
